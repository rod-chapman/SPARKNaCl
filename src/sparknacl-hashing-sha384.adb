...
is
   ...
   --  truncated output. Use this subtype for internal calculations.
   subtype Full_Digest is Bytes_64;

   pragma Warnings (GNATProve, Off, "pragma * ignored (not yet supported)");

   IV_384 : constant Full_Digest :=
   ...
   type K_Table_384 is array (Index_80) of U64;
   K_384 : constant K_Table_384 :=
   ...
   procedure Hashblocks_384
     (X : in out Full_Digest;
      M : in     Byte_Seq)
     with Global => null;
